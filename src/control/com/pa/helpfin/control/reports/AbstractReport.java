...
public abstract  class AbstractReport 
{
    ...
    protected NumberFormat nf = NumberFormat.getCurrencyInstance( ApplicationUtilities.getLocale() );
    ...
    protected void setTitle( String title, String icon ) throws Exception
    {
        ...
        if( icon != null )
        {
            ...
            Image img = Image.getInstance( ResourceLocator.getInstance().getImageResource( icon ) );
    ...
    {
        String user = ApplicationUtilities.getInstance().getActiveUserName();
        ...
        Platform.runLater( new Runnable() 
        {
            ...
            public void run() 
            {
                try 
                {
                    ...
                    document.addAuthor( "Artur Tomasi" );
                    document.addCreator( "HelpFin Application" );
                    document.addTitle( "Report HelpFin" );
